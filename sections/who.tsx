...
export function Who() {
  return (
    <section className="p-8 place-content-center bg-background">
      <div className="flex flex-col p-8 space-y-4 rounded-2xl bg-secondary mx-auto max-w-4xl">
        <div className="flex space-x-2 items-center">
          {/*<span className="min-h-4 min-w-4 h-4 w-4" />*/}
          <h4 className="text-4xl font-serif font-bold text-secondary-foreground">
